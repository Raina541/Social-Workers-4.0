...
const StickerBadge: React.FC<{ emoji: string; label: string; bgColor: string; textDark?: boolean }> = ({ emoji, label, bgColor, textDark = true }) => (
  ...
  >
    ...
    <Text style={{  fontSize: 10, fontWeight: 'bold', color: textDark ? '#3D2314' : '#ffffff', marginTop: 4, textAlign: 'center' }}>
      {label}
    </Text>
  </View>
);
...
const PolaroidFrame: React.FC<{
  ...
  rotation?: string;
  isBadge?: boolean;
}> = ({ imageUri, caption, size = 100, colors, style, isBadge = false }) => (
  <View
    style={[
      {
...
const ScrapbookCard: React.FC<{
  ...
  tapeColor?: string;
  tapeText?: string;
}> = ({ children, colors, style, isPrivate = false }) => {
  return (
      ...
      >
        ...
        {isPrivate && (
          ...
          >
            ...
            >
              <Text style={{ color: colors.text, fontWeight: 'bold', fontSize: 12, letterSpacing: 1 }}>
                🔒 PRIVATE LOG
              </Text>
            </View>
          </View>
...
const ScrapbookSectionHeader: React.FC<{
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6, marginTop: 18 }}>
    <View style={{ position: 'relative' }}>
      <Text style={{ fontSize: 16,  fontWeight: 'bold', color: colors.text, textTransform: 'uppercase', letterSpacing: 1.2 }}>
        {title}
      </Text>
...
const DEFAULT_JOURNEY_NODES: JourneyNode[] = [
  {
    ...
    date: 'June 2026',
    description: 'Planted 15 saplings in the town square, dug trenches, and helped set up a sustainable drip irrigation system to keep them watered.',
    imageUri: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=400&q=80'},
  {
    ...
    date: 'May 2026',
    description: 'Coordinated meal distribution, categorized pantry shelves, and managed raw supplies for over 150 local citizens in need.',
    imageUri: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?auto=format&fit=crop&w=400&q=80'},
  {
    id: '3',
    title: 'Coding Bootcamp Tutor',
    date: 'March 2026',
    description: 'Introduced basic programming concepts, loops, and condition statements to high schoolers, helping them compile their first interactive projects.',
    imageUri: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=400&q=80'},
  {
    id: '4',
    title: 'Elderly Care Visit & Storytelling',
    date: 'February 2026',
    description: 'Spent weekends at the Hope Retirement Home, organizing reading sessions, playing chess, and documenting oral history transcripts with residents.',
    imageUri: 'https://images.unsplash.com/photo-1581579438747-1dc8d1e0ca96?auto=format&fit=crop&w=400&q=80'},
  {
    id: '5',
    title: 'Stray Animal Welfare Campaign',
    date: 'January 2026',
    description: 'Assisted local veterinarians in feeding and administering vaccines to 25 stray dogs, establishing standard feeding zones in the community.',
    imageUri: 'https://images.unsplash.com/photo-1583337130417-3346a1be7dee?auto=format&fit=crop&w=400&q=80'},
];
    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          <Text style={{  fontSize: 18, fontWeight: 'bold', color: colors.text, letterSpacing: 1.5 }}>
            📓 MY SCRAPBOOK
          </Text>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            <Text style={{  fontSize: 12, fontWeight: 'bold', color: colors.text, opacity: 0.8, letterSpacing: 0.8 }}>
              ABOUT ME
            </Text>
            <View style={{
              flexDirection: 'row',
              ...
              <Text style={{  fontSize: 9, fontWeight: 'bold', color: colors.text, opacity: 0.6 }}>PUBLIC</Text>
            </View>
          </View>
        ...
        <View style={{ marginBottom: 16, marginTop: 6 }}>
          <Text style={{  fontSize: 13, fontWeight: 'bold', color: colors.text, marginBottom: 8, letterSpacing: 0.8 }}>
        ...
        >
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center' }}>
              ...
              <View style={{
                ...
                <Text style={{  fontSize: 9, fontWeight: 'bold', color: colors.text, opacity: 0.6 }}>COMMUNITY</Text>
              </View>
          ...
          <View style={{ gap: 12, paddingVertical: 6 }}>
            ...
            {domains.length === 0 && (
              <Text style={{  fontSize: 11, fontStyle: 'italic', color: colors.text, textAlign: 'center', marginVertical: 8 }}>
        ...
        >
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            <Text style={{  fontSize: 13, fontWeight: 'bold', color: colors.text, opacity: 0.8 }}>
              📊 THE NUMBERS
            </Text>
            <Pressable
          ...
          <View style={{
            ...
            alignItems: 'center',
            justifyContent: 'center'}}>
            <Text style={{  fontSize: 11, fontWeight: 'bold', color: colors.text, letterSpacing: 1 }}>
              ♥ certified volunteer ♥
            </Text>
          </View>
        </ScrapbookCard>
                ...
                return (
                  <View key={node.id}>
                    <View style={{
                      ...
                      <Text style={{  fontSize: 15, fontWeight: 'bold', color: colors.text, marginTop: 4 }}>
                        {node.title}
                      </Text>
                      <Text style={{  fontSize: 11, color: colors.text, marginTop: 6, lineHeight: 15 }}>
                        {node.description}
                      </Text>
                    </View>
                  </View>
        ...
        <ScrapbookCard colors={colors}>
          ...
          <View style={{ gap: 6 }}>
            <Text style={{ fontSize: 12, color: colors.text }}>• July 1 - Gwalior Plantation Drive (Registered)</Text>
            <Text style={{ fontSize: 12, color: colors.text }}>• July 15 - Children coding class (Teaching)</Text>
          </View>
        </ScrapbookCard>
        ...
        <View style={{
          ...
          <Pressable onPress={() => Alert.alert('Privacy Policy', 'Your scrapbook profile data is kept strictly safe and secure.')}>
            <Text style={{  fontSize: 11, color: colors.text, textDecorationLine: 'underline' }}>
              Privacy Policy
            </Text>
          </Pressable>

          <Pressable
            onPress={() => Alert.alert('Log Out', 'Are you sure you want to log out?', [{ text: 'Cancel', style: 'cancel' }, { text: 'Log Out', style: 'destructive', onPress: () => { if (onLogout) onLogout(); } }])}
            style={({ pressed }) => [
              {
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginTop: 20 }}>
                ...
                <Pressable
                  ...
                  style={{
                    ...
                    backgroundColor: colors.primary}}
                >
                  <Text style={{  fontWeight: 'bold', color: colors.text }}>Save Changes</Text>
                </Pressable>
              </View>
            </ScrollView>
          </View>
        ...
        <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
          ...
          >
            ...
            <View style={{ marginBottom: 20 }}>
              <Text style={{  fontSize: 13, fontWeight: 'bold', color: colors.text, textTransform: 'uppercase', marginBottom: 10 }}>
              ...
              <ScrapbookCard colors={colors}>
                <View style={{ alignItems: 'center', paddingVertical: 10 }}>
                  ...
                  <Text style={{ fontSize: 10,  color: colors.text, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 4 }}>
            ...
            <View style={{ marginBottom: 10 }}>
              <Text style={{  fontSize: 13, fontWeight: 'bold', color: colors.text, textTransform: 'uppercase', marginBottom: 12 }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginTop: 20 }}>
                ...
                <Pressable
                  ...
                  style={{
                    ...
                    backgroundColor: colors.primary}}
                >
                  <Text style={{  fontWeight: 'bold', color: colors.text }}>Add Card</Text>
                </Pressable>
              </View>
            </ScrollView>
          </View>
