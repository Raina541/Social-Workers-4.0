      ...
      <View style={styles.actionsBackground}>
        ...
        >
          {item.unread ? (
            ...
            <Ionicons name="close" size={22} color="#000000" style={{ opacity: 0.6 }} />
          )}
          <Text
            style={[
              styles.actionText,
              {
                color: item.unread ? themeColors.dangerForeground1 : '#000000',
        ...
        >
          ...
          <View style={styles.contentContainer}>
            <View style={styles.cardHeader}>
              <Text style={[Typography.bodyStrong, styles.senderName, { color: '#000000' }]}>
                {item.senderName}
              </Text>
              <Badge label={item.category} size="Small" intent="Informative" isDarkMode={isDarkMode} />
            </View>

            <Text style={[Typography.body, styles.messageBody, { color: '#000000', flexWrap: 'wrap' }]}>
              {item.title}: {item.body}
            </Text>

            <Text style={[styles.timestampText, { color: '#666666' }]}>
              {item.timeLabel}
            </Text>
